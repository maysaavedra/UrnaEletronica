...
function atualizaInterface(){
    ...
    if(candidato.length>0){
        ...
        seuVotoPara.style.display = 'block';
        aviso.style.display = 'block';
        descricao.innerHTML = '<div class="aviso--grande pisca"> VOTO NULO</div></div>';
    }
...
function clicou(n){
 ...
 function branco(){
    if(numero === ''){
        ...
        aviso.style.display = 'block';
        numeros.innerHTML = '';
        descricao.innerHTML = '<div class="aviso--grande pisca"> VOTO EM BRANCO</div></div>';
    }else{
...
function confirma(){
    ...
    if (votoConfirmado) {
        ...
        if (etapas[etapaAtual] !== undefined){
            ...
            document.querySelector('.tela').innerHTML ='<div class="aviso--gigante pisca"> FIM </div></div>';
            console.log(votos);
        }
